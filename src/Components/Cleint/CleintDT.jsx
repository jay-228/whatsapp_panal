...
const ClientDT = () => {
  ...
  const validationSchema = Yup.object({
    ...
    WhaCount: Yup.number().required("Count is required").positive().integer(),
    WhaBalCount: Yup.number()
      .required("Balance Count is required")
      .positive()
      .integer(),
    WhaDate: Yup.date()
          ...
          >
            {({ setFieldValue, values }) => (
              ...
              >
                ...
                <div className="mb-3">
                  <label className="form-label fw-bold">Balance Count</label>
                  <Field
                    type="number"
                    name="WhaBalCount"
                    className="form-control"
